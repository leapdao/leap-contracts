...
const FastExitHandlerMigration = artifacts.require('FastExitHandlerMigration');
...
contract('Migration', (accounts) => {
  ...
  describe('Test', () => {
    ...
    it('Can fast exit', async () => {
      ...
      let exitOwner = (await exitHandler.exits(utxoId))[2];
      ...
      FastExitHandlerMigration.link('PriorityQueue', pqLib.address);
      const exitHandlerMigrated = await FastExitHandlerMigration.new();
