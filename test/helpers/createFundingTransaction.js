...
const {PlasmaTransaction,
    ...
    TxTypeWithdraw, 
    TxTypeTransfer,
    TxLengthForTypes} = require("./Tx/tx");

const {TransactionInput, TransactionInputLength} = require("./Tx/input");
const {TransactionOutput, TransactionOutputLength} = require("./Tx/output");
const dummyInput = new TransactionInput();
const dummyOutput = new TransactionOutput();

module.exports = function(toAddressString, amountBN, depositIndexBN) {
