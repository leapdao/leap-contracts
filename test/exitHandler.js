  ...
  describe('Test', () => {
    ...
    describe('Start exit', async () => {
      ...
      it('Should allow to challenge exit by whitelisted tx', async () => {
        ...
        await exitHandler.startWhitelisting(transferProof, 0, '0x');
        await exitHandler.startWhitelisting(spendProof, 1, '0x');

        const execDepth = 10;
        const rootHash = transferTx.hash();
        await exitHandler.startWhitelisting(condProof, execDepth, rootHash);
